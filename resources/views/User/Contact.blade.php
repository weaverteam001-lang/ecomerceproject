                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="contact-info">
                                            ...
                                            <div class="contact-info-content">
                                              ...
                                              <p> Sector 11, Pratap Nagar, Jaipur, Rajasthan - 302033</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="contact-info">
                                            ...
                                            <div class="contact-info-content">
                                                <h5>Email Us</h5>
                                                <p>krishanyadavkd@gmail.com</p>
                                                <p>ky267459@gmail.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="col-lg-7">
                            <div class="contact-form">
                                ...
                                <form method="post" action="{{route('User.GetMessage')}}" id="contact-form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
...
<script>
    ...
    // 🔥 Individual validation errors bhi show karega
    @if($errors->any())
