...
@section('main-content')
      ...
      <main id="main-container">
        <!-- Hero -->
        <div class="bg-image" style="background-image: url('Admin/media/various/bg_dashboard.jpg');">
          ...
          <div class="row">
            <div class="col-md-6 col-xl-4">
              <a class="block block-rounded block-link-pop" href="javascript:void(0)">
                <div class="block-content block-content-full" style="min-height:160px;">
      ...
      @php
      $confirmedRevenue = DB::table('orders')
          ->where('status','Confirmed ')
          ->sum('total_price');
      @endphp            
            <div class="col-md-6 col-xl-4">
                    ...
                    <tbody>
                      <tr>
                        <td class="text-center">
                          <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('Admin/media/avatars/avatar8.jpg')}}" alt="">
                        </td>
                        <td>
                      ...
                      <tr>
                        <td class="text-center">
                          <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('Admin/media/avatars/avatar16.jpg')}}" alt="">
                        </td>
                        <td>
                      ...
                      <tr>
                        <td class="text-center">
                          <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('Admin/media/avatars/avatar10.jpg')}}" alt="">
                        </td>
                        <td>
                      ...
                      <tr>
                        <td class="text-center">
                          <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('Admin//media/avatars/avatar2.jpg')}}" alt="">
                        </td>
                        <td>
