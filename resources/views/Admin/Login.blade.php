  ...
  <body>
    ...
    <div id="page-container">
      ...
      <main id="main-container">
        <!-- Page Content -->
        <div class="bg-image" style="background-image: url('Admin/media/photos/photo22@2x.jpg');">
              ...
              <div class="p-3 w-100">
                ...
                <div class="row g-0 justify-content-center">
                  <div class="col-sm-8 col-xl-6">
                    <form class="js-validation-signin"action="javascript:void(0)" method="post" id="Login">
                      @csrf
                      <div class="py-3">
                        <div class="mb-4">
